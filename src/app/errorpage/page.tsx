...
export default function error({error , reset}: {error:Error , reset:()=>void}) {
  ...
  return (
    <div className='relative bg-[#F8FBFA]'>
      ...
      <FaLemon className='absolute top-[600px] left-30 text-4xl text-[#BBF7D0] animate-[float_3s_ease-in-out_infinite]'/>
      ...
      <FaSeedling className='absolute top-[600px] right-60 text-4xl text-[#BBF7D0] animate-[float_3s_ease-in-out_infinite]' />
...
<div className='w-180 h-auto border shadow-lg rounded-2xl flex flex-col items-center justify-center p-10 mb-20 ml-100'>
  ...
  <div className='flex gap-3'>
    ...
    <Link href='/allCategories' className='w-40 h-12 flex items-center justify-center rounded-lg py-3 px-5 bg-[#e7e9ee] hover:bg-[#d6d8dc] text-center'>Categories
     ...
     <Link href='/errorpage' className='w-40 h-12 flex items-center justify-center rounded-lg py-3 px-5 bg-[#e7e9ee] hover:bg-[#d6d8dc] text-center'>Today's Deals
    </Link>
